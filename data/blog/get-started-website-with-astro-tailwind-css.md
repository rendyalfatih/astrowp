...
title: 'Get started with AstroWP to create a website using Astro and Tailwind CSS'
description: 'Lorem ipsum dolor sit amet'
excerpt: 'Sint sit cillum pariatur eiusmod nulla pariatur ipsum. Sit laborum anim qui mollit tempor pariatur nisi minim dolor. Aliquip et adipisicing sit sit fugiat'
image: '~/assets/images/steps.jpg'
category: 'Tutorials'
tags: [astro, tailwind css]
canonical: https://AstroWP.vercel.app/get-started-website-with-astro-tailwind-css # When posting content to multiple platforms at the same time (such as this website and Medium) and want to specify the ultimate authority. Remove it to automatically generate canonical
---
